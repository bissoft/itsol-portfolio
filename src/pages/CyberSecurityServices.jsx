...
import { Shield, Lock, Eye, Server, Zap, ArrowRight, ChevronRight, CheckCircle, Clock, Code, RefreshCw, Globe, Users, ArrowLeft } from "lucide-react";
...
const CyberSecurityServices = () => {
  ...
  const services = [
    {
      ...
      description: "Identify security weaknesses before attackers exploit them",
    ...
    },
    {
      ...
      description: "Protect your cloud infrastructure from breaches",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/devops-&-cloud"
    },
    {
      ...
      description: "Eliminate vulnerabilities in your application code",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    },
    {
      ...
      description: "Meet GDPR, HIPAA, SOC2, and other regulatory requirements",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/cyber-security-services"
    },
    {
      ...
      description: "Rapid containment and recovery from security breaches",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/cyber-security-services"
    }
  ...
  const caseStudies = [
    {
      title: "Financial Sector Protection",
      description: "Reduced security incidents by 78% for a banking client",
      icon: <Shield className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "78% fewer incidents",
      tags: ["Penetration Testing", "GDPR Compliance", "SIEM"]
    },
    {
      title: "Healthcare Data Security",
      description: "Achieved HIPAA compliance for a hospital network",
      icon: <Lock className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "100% compliance",
      tags: ["Data Encryption", "Access Control", "Audit Logging"]
    },
    {
      title: "E-commerce Fraud Prevention",
      description: "Blocked $2M+ in fraudulent transactions annually",
      icon: <Eye className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "$2M+ saved",
      tags: ["AI Monitoring", "Behavior Analysis", "Real-time Alerts"]
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      >
        ...
        >
          <p className="text-sm font-medium text-blue-600">Cyber Security Services</p>
        </motion.div>
        ...
        >
          Protect Your Business with <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Advanced Security</span>
        </motion.h1>
        ...
        >
          Comprehensive cybersecurity solutions to safeguard your digital assets from evolving threats
        </motion.p>
        ...
        >
          ...
          >
            Get Security Audit <ArrowRight size={18} />
          </motion.button>
          <motion.button
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Cybersecurity Solutions</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-blue-50 rounded-3xl border border-blue-100">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Security Performance</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Measurable results that demonstrate our cybersecurity effectiveness
          </p>
        </motion.div>
              ...
              <div className="flex items-center gap-4 mb-2">
                ...
                <div className="flex-1">
                  <div className="flex justify-between">
                    ...
                    >
                      {stat.progress}{stat.name === "Incident Response Time" ? " minutes" : "%"}
                    </motion.span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-1">
                    <motion.div
                      className={`${stat.color} h-2.5 rounded-full relative`}
                      initial={{ width: 0 }}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Security Success Stories</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Real-world examples of our cybersecurity solutions in action
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              A proven methodology to protect your business:
            </p>
              ...
              {[
                {
                  ...
                  description: "Identify vulnerabilities and potential threats"
                },
                {
                  icon: <Lock className="text-blue-500 mt-1" />,
                  title: "Protection Strategy",
                  description: "Implement multi-layered security controls"
                },
                {
                  icon: <Eye className="text-blue-500 mt-1" />,
                  title: "Continuous Monitoring",
                  description: "24/7 surveillance of your systems"
                },
                {
                  icon: <RefreshCw className="text-blue-500 mt-1" />,
                  title: "Incident Response",
                  description: "Rapid containment and recovery plans"
                },
                {
          ...
          >
            ...
            {[
              { icon: <Shield className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 32, delay: 0 },
              { icon: <Lock className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 24, delay: 1 },
              { icon: <Eye className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 28, delay: 2 }
            ].map((element, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative z-10 text-white">Ready to Secure Your Business?</h2>
          <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg relative z-10">
            Get expert cybersecurity protection tailored to your needs
          </p>
