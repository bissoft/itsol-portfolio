...
import { UserCheck, MessageSquare, BarChart2, Zap, ArrowRight, ChevronRight, CheckCircle, Shield, Smartphone, Globe, Users, PieChart, Heart, Settings, Clock, ArrowLeft } from "lucide-react";
import { useNavigate } from "react-router-dom";

const CustomerExperienceOptimizationServices = () => {
  ...
  const services = [
    {
      ...
      description: "Identify pain points and optimize touchpoints for seamless experiences",
    ...
    },
    {
      ...
      description: "Unify customer interactions across all channels for consistency",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    },
    {
      ...
      description: "Leverage data to understand customer behavior and preferences",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/data-&-ai"
    },
    {
      ...
      description: "Tailor experiences to individual customer needs at scale",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/data-&-ai"
    },
    {
      ...
      description: "Build confidence with transparent data practices and security",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    {
      icon: Smartphone,
      title: "Mobile-First CX",
      description: "Optimize experiences for the growing mobile user base",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    {
      icon: Globe,
      title: "Global CX Localization",
      description: "Adapt experiences for cultural and regional preferences",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/web-app-development"
    },
    {
      ...
      description: "Capture and act on real customer feedback",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/data-&-ai"
    }
  ...
  const caseStudies = [
    {
      title: "E-commerce CX Overhaul",
      description: "Boosted conversion rates by 35% with personalized journey optimization",
      icon: <UserCheck className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "35% higher conversions",
      tags: ["Journey Mapping", "A/B Testing", "Personalization"]
    },
    {
      title: "Banking App Redesign",
      description: "Reduced customer service calls by 50% with intuitive UX improvements",
      icon: <Smartphone className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "50% fewer support tickets",
      tags: ["UI/UX", "Self-Service", "Mobile Optimization"]
    },
    {
      title: "Retail Omnichannel Sync",
      description: "Increased customer retention by 25% with seamless cross-channel experiences",
      icon: <Globe className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "25% retention boost",
      tags: ["Unified CX", "Loyalty Programs", "In-Store + Digital"]
    }
  ];
    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      >
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            Customer Experience and Optimization Services
          </motion.div>
        </div>
      </motion.div>
      {/* Hero Section */}
      ...
      >
        ...
        >
          <p className="text-sm font-medium text-blue-600">Customer Experience Optimization</p>
        </motion.div>
        ...
        >
          Transform Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Customer Experience</span>
        </motion.h1>
        ...
        >
          Data-driven strategies to enhance satisfaction, loyalty, and business growth.
        </motion.p>
        ...
        >
          ...
          >
            Optimize Your CX <ArrowRight size={18} />
          </motion.button>
          <motion.button
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">End-to-End CX Optimization</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Comprehensive services to elevate every customer interaction
          </p>
        </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-blue-50 rounded-3xl border border-blue-100">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Key CX Metrics We Improve</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Measurable impact on critical customer experience indicators
          </p>
        </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">CX Transformation Success Stories</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Real-world examples of customer experience optimization delivering results
          </p>
        </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-blue-50 rounded-3xl my-16 border border-blue-100">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <h2 className="text-3xl font-bold mb-6">Our CX Optimization Framework</h2>
            <p className="text-gray-600 mb-6">
              A proven methodology to systematically enhance customer experiences:
            </p>
              ...
              {[
                {
                  ...
                  description: "Deep qualitative and quantitative customer insights"
                },
                {
                  icon: <BarChart2 className="text-blue-500 mt-1" />,
                  title: "Journey Analysis",
                  description: "Mapping all touchpoints to identify friction points"
                },
                {
                  icon: <Settings className="text-blue-500 mt-1" />,
                  title: "Solution Design",
                  description: "Creating targeted improvements for key pain points"
                },
                {
                  icon: <Clock className="text-blue-500 mt-1" />,
                  title: "Rapid Testing",
                  description: "Validating changes through prototypes and A/B tests"
                },
                {
                  icon: <Heart className="text-blue-500 mt-1" />,
                  title: "Continuous Optimization",
                  description: "Ongoing measurement and refinement of experiences"
                }
              ].map((item, i) => (
                <motion.li
                  key={i}
          ...
          >
            {/* Animated CX elements */}
            {[
              { icon: <UserCheck className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 32, delay: 0 },
              { icon: <MessageSquare className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 24, delay: 1 },
              { icon: <Heart className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 28, delay: 2 }
            ].map((element, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative z-10 text-white">Ready to Elevate Your Customer Experience?</h2>
          <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg relative z-10">
            Let's discuss how we can help you build customer loyalty and drive growth
          </p>
...
export default CustomerExperienceOptimizationServices;
