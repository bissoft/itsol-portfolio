    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6">Contact Our Fintech Team</h2>
            <p className="text-gray-600 mb-8">
              Have questions about our financial technology solutions? Our experts are ready to help you navigate the digital transformation of your financial services.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:fintech@example.com" className="text-blue-600 hover:underline">
                    fintech@example.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+18005559876" className="text-blue-600 hover:underline">
                    +1 (800) 555-9876
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">24/7 technical support for all clients</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Tell us about your fintech needs..."
                  required
                ></textarea>
              </div>
      ...
      <section className="py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4 relative z-10 text-white">Ready to Transform Your Financial Services?</h2>
          <p className="text-blue-200 max-w-2xl mx-auto mb-8 relative z-10">
            Join hundreds of financial institutions leveraging our technology to power the future of finance.
          </p>
