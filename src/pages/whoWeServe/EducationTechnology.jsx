...
import { BookOpen, GraduationCap, Users, Clock, Shield, Award, Clipboard, ArrowRight, ChevronDown, Check, Star, MessageSquare, Code, Cloud, Lock, Monitor, Smartphone, Globe, BarChart2, Cpu, Wifi, Zap, Video, ChevronRight, ArrowLeft } from "lucide-react";
  ...
  const faqs = [
    {
      ...
      answer: "We follow WCAG 2.1 AA standards with screen reader compatibility, keyboard navigation, and adjustable interfaces."
    },
    {
      question: "Can you integrate with our existing SIS?",
      answer: "Yes, we integrate with all major Student Information Systems including PowerSchool, Blackboard, and custom solutions."
    }
  ];
