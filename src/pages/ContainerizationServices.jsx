...
import { Box, Cpu, Layers, Code, Server, Zap, ArrowRight, ChevronRight, CheckCircle, Shield, Database, Clock, RefreshCw, Settings, ArrowLeft } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Package applications into lightweight, portable containers for seamless deployment",
    ...
    },
    {
      ...
      description: "Deploy containers on AWS, Azure, or GCP with optimized infrastructure",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/devops-&-cloud"
    },
    {
      ...
      description: "Break monoliths into scalable, independently deployable services",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    {
      icon: Database,
      title: "Stateful Containerization",
      description: "Manage databases & persistent storage in containerized environments",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/data-&-ai"
    },
    {
      ...
      description: "Implement vulnerability scanning, runtime protection, and compliance",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
    ...
    },
    {
      ...
      description: "Automate build, test, and deployment workflows for containers",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
      path: "/devops-&-cloud"
    },
    {
      ...
      description: "Track performance and troubleshoot containerized applications",
      color: "from-blue-400 to-blue-600",
      hoverColor: "hover:shadow-blue-500/20",
  ...
  const caseStudies = [
    {
      ...
      description: "Migrated monolithic app to Kubernetes, reducing costs by 40%",
      icon: <Layers className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "40% cost reduction",
      tags: ["Kubernetes", "AWS EKS", "Microservices"]
    },
    {
      title: "Healthcare App Containerization",
      description: "Improved deployment speed by 75% with Docker & CI/CD pipelines",
      icon: <Box className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "75% faster deployments",
      tags: ["Docker", "Azure", "GitLab CI"]
    },
    {
      title: "FinTech Auto-Scaling",
      description: "Achieved 99.99% uptime with Kubernetes auto-scaling",
      icon: <Server className="text-blue-500" />,
      color: "bg-blue-100",
      impact: "99.99% uptime",
      tags: ["GKE", "HPA", "Prometheus"]
    }
  ];

  const benefits = [
    {
      name: "Faster Deployments",
      progress: 85,
      color: "bg-blue-500",
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      >
        ...
        >
          <p className="text-sm font-medium text-blue-600">DevOps Services</p>
        </motion.div>
        ...
        >
          Modern <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Containerization & Orchestration</span>
        </motion.h1>
        ...
        >
          Accelerate deployments, improve scalability, and streamline operations with Docker & Kubernetes.
        </motion.p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Container & Orchestration Services</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            End-to-end solutions to optimize your containerized workloads
          </p>
        </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-blue-50 rounded-3xl border border-blue-100">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Key Benefits of Containerization</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            How containerization transforms application deployment
          </p>
        </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Containerization Success Stories</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-blue-50 rounded-3xl my-16 border border-blue-100">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <h2 className="text-3xl font-bold mb-6">Our Containerization Process</h2>
            <p className="text-gray-600 mb-6">
              A structured approach to ensure successful container adoption:
            </p>
              ...
              {[
                {
                  ...
                  description: "Evaluate application suitability for containers"
                },
                {
                  icon: <Code className="text-blue-500 mt-1" />,
                  title: "Containerization Strategy",
                  description: "Dockerize apps with optimized images"
                },
                {
                  icon: <Layers className="text-blue-500 mt-1" />,
                  title: "Orchestration Setup",
                  description: "Deploy Kubernetes or managed services"
                },
                {
                  icon: <Shield className="text-blue-500 mt-1" />,
                  title: "Security Hardening",
                  description: "Implement scanning & runtime protection"
                },
                {
          ...
          >
            ...
            {[
              { icon: <Box className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 32, delay: 0 },
              { icon: <Layers className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 24, delay: 1 },
              { icon: <Server className="text-blue-500" />, color: "bg-blue-100", border: "border-blue-200", size: 28, delay: 2 }
            ].map((element, i) => (
              <motion.div
                key={i}
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative z-10 text-white">Ready to Containerize Your Applications?</h2>
          <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg relative z-10">
            Let’s discuss how we can optimize your deployments with Docker & Kubernetes
          </p>
