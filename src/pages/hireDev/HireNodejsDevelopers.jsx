...
const HireNodeJsDevelopers = () => {
  const [activeTab, setActiveTab] = useState("why-node");
  ...
  const features = [
    {
      ...
      description: "Event-driven architecture handles thousands of concurrent connections",
      extended: "Our Node.js developers leverage non-blocking I/O and the V8 engine to build applications that scale effortlessly while maintaining high throughput."
    },
    {
      icon: <Globe className="text-blue-500 w-8 h-8" />,
      title: "Real-time Capabilities",
      description: "Ideal for applications requiring live updates and interactions",
      extended: "We use WebSockets and frameworks like Socket.io to build real-time features such as chat, notifications, and live dashboards with minimal latency."
    },
    {
      icon: <Database className="text-blue-500 w-8 h-8" />,
      title: "Full-stack JavaScript",
      description: "Shared language between frontend and backend",
      extended: "Our teams work efficiently across the stack using JavaScript/TypeScript, reducing context switching and enabling seamless data flow between client and server."
    },
    {
      icon: <Cloud className="text-blue-500 w-8 h-8" />,
      title: "Cloud Native",
      description: "Optimized for serverless and microservices architectures",
      extended: "We architect Node.js applications for cloud deployment using containers, serverless functions, and orchestration tools to ensure scalability and reliability."
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Rapid development with npm ecosystem"
    },
    {
      title: "Cost Efficiency",
      description: "Single language across the stack reduces costs"
    },
    {
      title: "Scalability",
      description: "Handles high traffic with minimal resources"
    },
    {
      title: "Community Support",
      description: "Access to thousands of open-source packages"
    }
  ];
  ...
  const hiringModels = [
    {
      ...
      description: "Complete Node.js team for your project",
      price: "Custom",
      features: ["Senior developers", "Project manager", "QA engineers"]
    },
    {
      title: "Full-time Developer",
      description: "Single dedicated Node.js engineer",
      price: "$5,000+/mo",
      features: ["40+ hours/week", "Direct communication", "Flexible engagement"]
    },
    {
      title: "Hourly Consulting",
      description: "Pay-as-you-go Node.js expertise",
      price: "$80-$130/hr",
      features: ["Specific tasks", "Code reviews", "Architecture consulting"]
    }
  ];
  ...
  const techStack = [
    {
      category: "Frameworks",
      items: ["Express.js", "NestJS", "Fastify", "Koa"]
    },
    {
      category: "Databases",
  ...
  return (
    <div className="bg-white text-gray-800">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              >
                <p className="text-sm font-medium">Hire Top Node.js Talent</p>
              </motion.div>
               */}
              <motion.h1 
              ...
              >
                Hire Expert <span className="text-blue-600">Node.js Developers</span>
              </motion.h1>
              ...
              >
                Build scalable, high-performance applications with our vetted Node.js engineers. 
                From APIs to real-time systems, we deliver robust solutions.
              </motion.p>
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Why Node.js?</h3>
                  <p className="text-gray-600 mb-6">
                    Node.js enables building fast, scalable network applications using JavaScript 
                    on both client and server sides.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { icon: <Zap />, text: "Fast" },
                      { icon: <Server />, text: "Scalable" },
                      { icon: <CpuIcon />, text: "Efficient" },
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold mb-4">Node.js Development Expertise</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our Node.js developers bring deep technical knowledge to build 
      ...
      <section className="py-20 bg-gray-50">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold mb-4">Our Node.js Tech Stack</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We work with modern tools and technologies in the Node.js ecosystem
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            How hiring our Node.js developers delivers value to your organization
          </p>
        </motion.div>
            ...
            {hiringModels.map((model, i) => (
              ...
              >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                  className={`w-full py-3 rounded-lg font-medium cursor-pointer ${i === 1 ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600'}`}
                  onClick={()=> navigate('/get-in-touch')}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              Let's discuss how our Node.js experts can help you build scalable, 
