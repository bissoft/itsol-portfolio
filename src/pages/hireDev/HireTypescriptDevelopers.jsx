...
const HireTypeScriptDevelopers = () => {
  const [activeTab, setActiveTab] = useState("why-typescript");
  ...
  const features = [
    {
      icon: <Type className="text-blue-500 w-8 h-8" />,
      title: "Type Safety",
      description: "Catch errors during development, not in production",
      extended: "Our TypeScript developers leverage static typing to identify potential issues during development, reducing runtime errors and improving code reliability."
    },
    {
      icon: <FileText className="text-blue-500 w-8 h-8" />,
      title: "Enhanced Documentation",
      description: "Self-documenting code with type definitions",
      extended: "TypeScript's type system serves as built-in documentation, making codebases more maintainable and easier to understand for new team members."
    },
    {
      icon: <Bug className="text-blue-500 w-8 h-8" />,
      title: "Reduced Bugs",
      description: "Static analysis catches common mistakes",
      extended: "We use TypeScript's compiler to catch type-related bugs early, resulting in more stable applications with fewer production issues."
    },
    {
      icon: <GitMerge className="text-blue-500 w-8 h-8" />,
      title: "Better Collaboration",
      description: "Clear contracts between components and teams",
      extended: "TypeScript interfaces and types create explicit contracts that improve collaboration across teams and make large-scale development more manageable."
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Type checking leads to more robust applications"
    },
    {
      title: "Easier Refactoring",
      description: "Confidently change code with compiler support"
    },
    {
      title: "Modern JavaScript Features",
      description: "Latest ECMAScript with type safety"
    },
    {
      title: "Framework Agnostic",
      description: "Works with React, Angular, Vue, Node.js and more"
    }
  ];
  ...
  const hiringModels = [
    {
      ...
      description: "Complete TypeScript team for your project",
      price: "Custom",
      features: ["Senior developers", "Project manager", "QA engineers"]
    },
    {
      title: "Full-time Developer",
      description: "Single dedicated TypeScript engineer",
      price: "$5,500+/mo",
      features: ["40+ hours/week", "Direct communication", "Flexible engagement"]
    },
    {
      title: "Hourly Consulting",
      description: "Pay-as-you-go TypeScript expertise",
      price: "$90-$140/hr",
      features: ["Code reviews", "Migration assistance", "Performance optimization"]
    }
  ];
  ...
  const techStack = [
    ...
    },
    {
      ...
      items: ["Node.js", "NestJS", "Express", "Fastify"]
    },
    {
      category: "Testing",
      items: ["Jest", "Mocha", "Cypress", "Playwright"]
    },
    {
      category: "Tooling",
      items: ["Webpack", "Babel", "ESLint", "Prettier"]
    }
  ];
  ...
  return (
    <div className="bg-white text-gray-800">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              >
                <p className="text-sm font-medium">Hire Top TypeScript Talent</p>
              </motion.div> */}
              ...
              >
                Hire Expert <span className="text-blue-600">TypeScript Developers</span>
              </motion.h1>
              ...
              >
                Build robust, type-safe applications with our vetted TypeScript engineers. 
                From frontend to backend, we deliver high-quality typed solutions.
              </motion.p>
              ...
              >
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                  className="px-8 py-3 bg-white border-2 border-blue-300 text-blue-600 cursor-pointer rounded-lg font-medium flex items-center gap-2"
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Why TypeScript?</h3>
                  <p className="text-gray-600 mb-6">
                    TypeScript brings type safety to JavaScript, enabling developers to 
                    catch errors early and build more maintainable applications.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { icon: <Type />, text: "Type Safe" },
                      { icon: <Shield />, text: "Reliable" },
                      { icon: <Cpu />, text: "Scalable" },
                      { icon: <GitMerge />, text: "Collaborative" }
                    ].map((item, i) => (
                      <motion.div 
                        key={i}
                        whileHover={{ y: -5 }}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold mb-4">TypeScript Development Expertise</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our TypeScript developers bring deep technical knowledge to build 
            robust, type-safe applications across the stack.
          </p>
        </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold mb-4">Our TypeScript Tech Stack</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We work with TypeScript across the entire development stack
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            How hiring our TypeScript developers delivers value to your organization
          </p>
        </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              Let's discuss how our TypeScript experts can help you build robust, 
              type-safe applications tailored to your needs.
            </motion.p>
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
