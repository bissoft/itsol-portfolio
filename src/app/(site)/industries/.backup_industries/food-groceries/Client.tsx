...
import { ShoppingCart, Truck, Package, Shield, Clock, Users, ArrowRight, ChevronDown, Check, Star, Globe, BarChart2, Cpu, ShoppingBag, ChevronRight, ArrowLeft, Code, Cloud, Lock, Zap, Smartphone } from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, idx) => (
                        ...
                        >
                            ...
                            {/* Default Content */}
                            <div className="bg-white p-6 group-hover:opacity-0 transition-opacity duration-300">
