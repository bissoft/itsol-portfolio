...
import { BookOpen, GraduationCap, Users, Clock, Shield, Award, Clipboard, ArrowRight, ChevronDown, Check, Star, Monitor, Smartphone, BarChart2, Cpu, Cloud, Lock, Zap, ChevronRight, ArrowLeft } from "lucide-react";
...
const EducationTechnology = () => {
    ...
    // Stats Data
    const stats = [
        { value: "100+", label: "Educational Institutions", icon: <GraduationCap className="text-blue-500" /> },
        { value: "1M+", label: "Students Reached", icon: <Users className="text-blue-500" /> },
        { value: "40%", label: "Learning Improvement", icon: <Award className="text-blue-500" /> },
        { value: "24/7", label: "Accessibility", icon: <Clock className="text-blue-500" /> }
    ];
    ...
    const solutions = [
        {
            ...
            title: "LMS Platforms",
            description: "Custom learning management systems for schools and universities"
        },
        {
        ...
        },
        {
            ...
            description: "Engaging mobile learning experiences"
        },
        {
    ...
    const features = [
        ...
        {
            title: "Gamification",
            description: "Engagement through badges, leaderboards, and rewards",
            icon: <Award className="text-blue-500" />
        },
        {
            title: "Collaboration Tools",
            description: "Real-time student-teacher interaction",
    ...
    const caseStudies = [
        {
            ...
            challenge: "Needed modern platform for 50,000+ students",
            solution: "Developed custom LMS with 100+ integrations",
            results: [
                "95% adoption rate",
                "30% improvement in course completion",
        ...
        },
        {
            ...
            challenge: "Low engagement with traditional materials",
            solution: "Interactive app with gamified learning",
            results: [
                "4.8/5 student satisfaction",
                "40% faster concept mastery",
                "300% more homework completion"
            ]
        }
    ];
    ...
    const testimonials = [
        {
            quote: "The LMS platform transformed how our faculty teaches and students learn.",
            author: "Dr. Sarah Johnson",
            role: "Dean of Technology, State University",
            rating: 5
        },
        {
            quote: "Our student engagement metrics tripled after implementing their learning app.",
            author: "Michael Chen",
            role: "Superintendent, School District",
            rating: 5
        }
    ];
    ...
    const whyChooseUs = [
        {
            icon: <Clipboard className="text-blue-500" />, // Replaced Code with Clipboard as Code wasn't imported from lucide-react in original snippet but used in array. Checking imports... Code IS imported. Okay using Clipboard as placeholder or I should add Code to imports. Ah, Code IS in imports.
            title: "Education Specialists",
            description: "Developers with 10+ years in edtech"
        },
        {
            icon: <Cloud className="text-blue-500" />,
            title: "Scalable Platforms",
            description: "Solutions that grow with your institution"
        },
        {
            icon: <Lock className="text-blue-500" />,
            title: "Security Compliant",
            description: "FERPA and COPPA compliant solutions"
        },
        {
            icon: <Zap className="text-blue-500" />,
            title: "Rapid Deployment",
            description: "Quick implementation without sacrificing quality"
        }
    ];
    ...
    const projects = [
        {
            ...
            description: "Comprehensive learning platform for higher education",
            tags: ["LMS", "Higher Ed", "Integrations"],
            icon: <BookOpen className="w-12 h-12 text-blue-500" />
        },
        {
            id: 2,
            title: "K-12 Learning App",
            description: "Interactive curriculum for elementary students",
            tags: ["Mobile", "Gamification", "K-12"],
            icon: <GraduationCap className="w-12 h-12 text-blue-500" />
        },
        {
            id: 3,
            title: "Corporate Training",
            description: "Enterprise learning and development platform",
            tags: ["Corporate", "Training", "Certification"],
        ...
        <div className="min-h-screen bg-white text-gray-800">
            ...
            >
                ...
                >
                    ...
                    >
                        <p className="text-sm font-medium text-blue-600">Transforming Education</p>
                    </motion.div>
                    ...
                    >
                        Digital platforms that enhance teaching, learning, and administration
                    </motion.p>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
                <div className="text-center mb-16">
                    ...
                    >
                        Why Choose Us for Education Technology
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0 }}
                    ...
                    >
                        Specialized expertise to build effective learning solutions
                    </motion.p>
                </div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-white">
                <div className="text-center mb-16">
                    ...
                    <motion.p
                        ...
                        className="text-xl text-gray-600 max-w-3xl mx-auto"
                    >
                        Comprehensive digital solutions for modern education
                    </motion.p>
                </div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
                <div className="text-center mb-16">
                    ...
                    <motion.p
                        ...
                        className="text-xl text-gray-600 max-w-3xl mx-auto"
                    >
                        Innovative solutions transforming education delivery
                    </motion.p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, idx) => ( // Removed hoveredProject logic as it was causing issues in legacy, just simple hover effect
                        <motion.div
                            key={project.id}
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                        ...
                        >
                            ...
                            {/* Hover Overlay */}
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-blue-700/90 to-blue-900/90 flex flex-col justify-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            >
                                <div className="mb-4">
                            ...
                            {/* Default Content */}
                            <div className="bg-white p-6 group-hover:opacity-0 transition-opacity duration-300"> {/* Hide default content on hover to avoid overlap visuals if transparent */}
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-50">
                <div className="text-center mb-16">
                    ...
                    <motion.p
                        ...
                        className="text-xl text-gray-600 max-w-3xl mx-auto"
                    >
                        Proven results delivering transformative education solutions
                    </motion.p>
                </div>
            ...
            <section className="py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                >
                    ...
                    <h2 className="text-3xl font-bold mb-4 text-white">Ready to Transform Education?</h2>
                    <p className="text-blue-100 max-w-2xl mx-auto mb-8">
                        Our team specializes in building digital learning solutions for institutions
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <motion.button
