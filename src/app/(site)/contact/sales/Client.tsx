...
import { ArrowRight, Check, Zap, BarChart2, Shield, Users, Clock, ChevronRight, ArrowLeft } from "lucide-react";
                    ...
                    <div className="inline-flex bg-blue-50 rounded-lg p-1">
                        {[
                            ...
                            <motion.button
                                ...
                                className={`px-6 py-3 rounded-md text-sm font-medium transition-all ${activeTab === tab.id ? 'bg-blue-500 text-white' : 'text-gray-600 hover:text-blue-500'
                                    }`}
                    ...
                    {caseStudies.map((study, index) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <motion.button
                                    whileHover={{ x: 5 }}
                                    className="flex items-center gap-1 text-blue-500 font-medium cursor-pointer"
                                    onClick={() => router.push('/portfolio')} // Assuming case studies will be migrated there
                                >
