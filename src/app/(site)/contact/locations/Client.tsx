...
const Locations = () => {
    ...
    const [expandedRegion, setExpandedRegion] = useState<string | null>("americas");
                            ...
                            {Object.entries(regions).map(([key, region]) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <ChevronDown
                                            className={`text-blue-500 transform transition-transform ${expandedRegion === key ? "rotate-180" : ""
                                                }`}
                                        />
                                    </button>
                                        ...
                                        >
                                            {region.locations.map((location) => (
                                                <motion.button
                                                    ...
                                                    className={`w-full text-left p-6 hover:bg-blue-100/50 transition-colors flex items-start gap-4 ${activeLocation === location.id
                                                        ? "bg-blue-100"
                                                        : ""
                                                        }`}
                                                >
                                                    <MapPin
                                                        className={`mt-1 flex-shrink-0 ${activeLocation === location.id
                                                            ? "text-blue-500"
                                                            : "text-blue-400"
                                                            }`}
                                                    />
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                                ...
                                <div className="h-80 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center relative">
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        className="absolute bottom-4 right-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm cursor-pointer"
                                    >
                                        View on Map
                                    </motion.button>
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        ...
                                        <div>
                                            ...
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.97 }}
                                                className="mt-8 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium py-3 px-6 rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer"
                                            >
                                                Get Directions
                                            </motion.button>
                                        </div>
