      ...
      <div className="z-10 relative max-w-8xl mx-auto w-full flex flex-col items-center pt-30 pb-10">
        ...
        <div className="text-center flex flex-col items-center px-6 lg:px-0 max-w-5xl mx-auto relative z-20">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold tracking-tight text-black-700 mb-8 leading-tight"
          >
            End-to-End Digital Solutions <br />
            <span className="text-black-600">in One Place</span>
          </motion.h1>
          ...
          >
            We architect robust digital solutions that scale. From <span className="text-blue-600 font-medium">AI-driven platforms</span> to <span className="text-blue-600 font-medium">enterprise ecosystems</span>, we turn complex challenges into elegant software.
          </motion.p>
          ...
          >
            <div className="relative h-40 bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center p-4 group cursor-pointer overflow-hidden">
              ...
              <div className="relative z-10 text-center p-3 border border-white/20 bg-white/10 backdrop-blur-md rounded-xl w-full">
                <h3 className="text-sm font-bold text-white leading-tight mb-0.5">Strategic Playbook</h3>
                <h3 className="text-lg font-extrabold text-white leading-none mb-1">Modernization</h3>
                <span className="inline-block px-2 py-0.5 rounded-full bg-blue-500/30 text-[10px] font-semibold text-white border border-blue-400/30">2026 Edition</span>
              </div>
            </div>

            <div className="p-4">
              <h3 className="text-xs font-bold text-gray-900 mb-1 leading-snug">Digital Transformation Roadmap</h3>
              <a href="#" className="inline-flex items-center gap-1.5 text-blue-600 hover:text-blue-700 transition-colors font-semibold group text-xs">
                Get the whitepaper
        ...
        <div className="xl:hidden w-full max-w-[280px] mt-12 px-6">
          ...
          >
            ...
            <div className="p-4 text-center">
              <h3 className="text-xs font-bold text-gray-900 mb-1">Digital Transformation Roadmap</h3>
              <span className="text-blue-600 font-semibold text-xs">Download Now &rarr;</span>
            </div>
          </motion.div>
        </div>
