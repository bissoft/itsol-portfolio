    ...
    <div className="min-h-screen bg-white text-gray-800 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">
              Advanced capabilities engineered to drive efficiency and
              performance
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg">
              Detailed breakthroughs from our recent sector partnerships
            </p>
          </div>
          <div className="w-full max-w-4xl space-y-4">
            {data.caseStudies?.map((cs: any, i: number) => (
              ...
              >
                <button
                  onClick={() =>
                    setExpandedCaseStudy(expandedCaseStudy === i ? null : i)
                  }
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm font-medium">
                        {cs.challenge.substring(0, 60)}...
                      </p>
                    </div>
                  </div>
                  <ChevronDown
                    className={`text-gray-300 group-hover:text-blue-600 transition-all ${expandedCaseStudy === i ? "rotate-180" : ""}`}
                  />
                </button>
                <AnimatePresence>
                  {expandedCaseStudy === i && (
                    <motion.div
                      ...
                      className="px-8 pb-8"
                    >
                      <div className="grid md:grid-cols-2 gap-12 pt-4 border-t border-gray-50">
                        <div>
                        ...
                        <div className="bg-blue-50/50 rounded-[2rem] p-8">
                          <h4 className="text-xs font-black text-blue-900 uppercase tracking-widest mb-6">
                            Key Results
                          </h4>
                          <ul className="space-y-4">
                            {cs.results?.map((res: string, j: number) => (
                              <li key={j} className="flex items-start gap-3">
                                <div className="w-5 h-5 rounded-full bg-blue-600 flex items-center justify-center text-white flex-shrink-0 mt-0.5">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto rounded-[3rem] bg-gradient-to-br from-blue-700 to-blue-900 p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-sky-400/10 rounded-full blur-3xl -ml-32 -mb-32 text-white"></div>

          <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
            Ready to Elevate Your Global Sector?
          </h2>
          <p className="text-blue-100 text-lg mb-12 max-w-2xl mx-auto leading-relaxed">
            Let's build a secure, future-proof digital infrastructure together.
