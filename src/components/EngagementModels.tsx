...
const EngagementModels = () => {
  ...
  const content: Record<string, any> = {
    dev: {
      ...
      description:
        "From validation to MVP and full-scale product development, we build robust software solutions tailored to your business goals.",
      features: [
    ...
    managed: {
      ...
      description:
        "Focus on your core business while we handle your IT infrastructure, security, and maintenance with our managed services.",
      features: [
    ...
    team: {
      ...
      description:
        "Upgrade your team with specialized skills & expertise. Scale your development capacity instantly with our vetted engineers.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose from flexible engagement models tailored to your needs,
            ensuring seamless collaboration with time & material or dedicated
            teams.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 ${
                activeTab === tab.id
            ...
            >
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {content[activeTab].features.map(
