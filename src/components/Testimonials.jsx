...
const testimonials = [
  {
    ...
    content: "Working with ITSOL was transformative for our platform. Their understanding of complex financial architectures and ability to deliver scalable solutions is unmatched.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The team's dedication to quality and user experience helped us launch our learning platform 2 months ahead of schedule. Exceptional communication throughout.",
    rating: 5,
  ...
  },
  {
    ...
    content: "We needed a partner who understood both medical compliance and modern AI tech. ITSOL delivered a secure, HIPAA-compliant solution that serves thousands of patients.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The e-commerce revamp increased our conversion rates by 40%. The attention to detail in the UI/UX design was exactly what we needed to stand out.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            See what industry leaders are saying about their collaboration with us.
          </p>
        </div>
