...
const values = [
  {
    ...
    description:
      "You own every line of code. We transfer all intellectual property rights to you immediately upon delivery.",
  },
  {
    icon: Clock,
    title: "Timezone Overlap",
    description:
      "We align our working hours with yours to ensure seamless communication and real-time collaboration.",
  },
  {
    icon: Zap,
    title: "Strict NDA & Security",
    description:
      "Your secrets are safe with us. We sign NDA before initial discussion and adhere to strict security protocols.",
  },
  {
    icon: Layers,
    title: "Agile Process",
    description:
      "Development in two-week sprints gives you visibility and control over progress, priorities, and budget.",
  },
  {
    icon: User,
    title: "Free Project Manager",
    description:
      "Get a dedicated Project Manager at no extra cost to handle logistics, reporting, and team coordination.",
  },
  {
    icon: Layers, // Changed icon to avoid duplicate Use imports if needed, Layers is fine for DevOps
    title: "DevOps & QA Included",
    description:
      "We don't just code; we ensure quality and deployment readiness with integrated QA and DevOps practices.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed">
              We provide a comprehensive ecosystem of services and guarantees to
              ensure your project's success. No hidden clauses, no
              surprises—just transparent, high-quality partnership.
            </p>
            ...
            <motion.button
              ...
              onClick={() =>
                window.open(
                  "https://calendly.com/etechnocrat/saas-app",
                  "_blank",
                )
              }
            >
