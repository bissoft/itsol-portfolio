...
const projects = [
  {
    ...
    challenge:
      "Customer support teams were overwhelmed with repetitive queries, leading to long wait times and decreased customer satisfaction. The client needed a scalable solution to handle high volumes of interactions without compromising quality.",
    solution:
      "We developed a sophisticated NLP model capable of understanding context and sentiment. Integrated with the client's existing CRM, Amelia.ai can resolve 80% of common queries autonomously while seamlessly handing over complex issues to human agents.",
  ...
  // Fallback for other IDs just to show the layout
  {
    ...
    website: "#",
    description:
      "A transformative digital solution designed to optimize workflows and enhance user engagement through modern web technologies.",
    challenge:
      "The client struggled with legacy systems that were slow, non-responsive, and difficult to maintain. They needed a complete digital overhaul to remain competitive in a fast-paced market.",
    solution:
      "We re-architected the entire platform using a modern MERN stack, implementing a headless CMS for easy content management and a design system that ensures consistency across all digital touchpoints.",
    ...
    <div className="min-h-screen bg-white">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((tech, i) => (
                  <span
                    key={i}
                    className="px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition-colors cursor-default"
                  >
                    {tech}
                  </span>
                ))}
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h2
            className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 cursor-pointer hover:text-blue-600 transition-colors"
